/**
 * $http decorator to filter duplicate requests.
 *
 * @see https://gist.github.com/adambuczynski/354364e2a58786e2be71
 *
 */
define([
    'angular'
    ...
    var DuplicateRequestsDecorator = function($provide) {
    ...
    function initConfig(app) {
        app.config(['$provide', DuplicateRequestsDecorator]);
    }

    ...
    define(dependencies, function(AppBootstrap, $, TestModel, UploadModel, BaseModel) {
        ...
        describe('Form edit + cancel + submit', function() {
            ...
            it('edit mode is enabled', function() {
                ...
                expect($($element.find('button')[1]).attr('class')).toEqual('btn btn-primary form-button');

                // AND cancel button should be hidden
                expect($($element.find('button')[2]).attr('class')).toEqual('btn btn-primary form-button ng-hide');
                ...
                expect($($element.find('button')[1]).attr('class')).toEqual('btn btn-primary form-button ng-hide');

                // AND cancel button should be visible
                expect($($element.find('button')[2]).attr('class')).toEqual('btn btn-primary form-button');
            });
            ...
            it('edited changes are cancelled', function() {
                ...
                expect($formScope.canSubmit()).toBeTruthy();
                expect($($element.find('button')[0]).attr('class')).toEqual('btn btn-primary form-button');
                ...
                expect($($element.find('button')[0]).attr('class')).toEqual('btn btn-primary form-button ng-hide');

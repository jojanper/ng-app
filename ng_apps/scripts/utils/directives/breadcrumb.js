define([
...
], function (BreadcrumbTemplate, Signals) {
    "use strict";
    ...
    var Breadcrumb = function ($state, utilsfactory) {
        return {
            ...
            controller: ['$scope', '$element', '$attrs', 'appUrlResolver', function($scope, $element, $attrs, appUrlResolver) {
                ...
                $scope.$on("$stateChangeSuccess", function () {
                    ...
                    if ($scope.breadcrumbs.length) {
                        ...
                        utilsfactory.getPageModels($scope.breadcrumbs[0].state, function(appModels, selectedModelDisplayName) {
